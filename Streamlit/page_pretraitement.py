...
def pretraitement():
    ...
    st.markdown("#### 1. Standardisation et binarisation")
    st.markdown("##### a. Standardisation des données quantitatives")
    st.markdown(texte_justifie(
        ...
        "<ul>"
            ...
            "<li><code>ratioSC</code> : standardisation à l'aide de <code>MinMaxScaler</code> qui réduit l'intervalle "
                "de variation de la variable de manière proportionnelle."
        "</ul>"), unsafe_allow_html=True)
    st.markdown("<br>", unsafe_allow_html=True)

    st.markdown("##### b. Binarisation des variables catégorielles")
    st.markdown(texte_justifie(
            "C'est à dire <code>IncGeo_BoroughCode</code> et <code>PropertyCategory</code>.")
    , unsafe_allow_html=True)
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("<br>", unsafe_allow_html=True)
    ...
    st.markdown("#### 2. Travail sur la variable cible")
    st.markdown(texte_justifie(
        "Pour la variables cible nous avons été amené à évoluer au cours de nos travaux, notre variable cible"
    ...
    st.markdown("#### 3. Création des jeux de données d'entrainement, de validation et de test")
    st.markdown(texte_justifie(
